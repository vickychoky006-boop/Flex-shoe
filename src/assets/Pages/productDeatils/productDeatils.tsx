...
import img1 from"../../img/Product-Details/Men/card1/img1.jpg"
import img2 from"../../img/Product-Details/Men/card1/img2.jpg"
import img3 from"../../img/Product-Details/Men/card1/img3.jpg"
import img4 from"../../img/Product-Details/Men/card1/img4.jpg"
...
function ProductDetails(){
  ...
  <div className="row">
    ...
    <div className="col-lg-1">
      <div className="thumb-list">
        ...
        <img src={card1} className="thumb-img" onClick={() => setMainImg(card1)}/>
      </div>
    </div>
  ...
  <div className="price-section">
    <span className="mrp">MRP: ₹10,999</span>
    <span className="sale-price">₹6,999</span>
  ...
  <div className="delivery-box">
    <label>ADD Delivery Challan</label>
